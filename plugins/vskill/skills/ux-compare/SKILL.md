...
If the target project has `CLAUDE.md` at its root, that file **outranks this skill**. When you synthesise recommendations, honour the project's stated design system and UX conventions — the goal is to frame external references against the project's rules, not to override them.
