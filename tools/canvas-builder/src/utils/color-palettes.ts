...
/**
 * Maps our 0-1000 palette to Tailwind's 50-950 shade scale.
 * Our 0 = lightest (white), 1000 = darkest (black), 500 = primary.
 * Tailwind 50 = lightest, 950 = darkest, 500 = primary.
 */
